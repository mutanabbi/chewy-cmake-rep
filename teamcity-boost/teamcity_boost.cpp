...
static std::string toString(const boost::execution_exception& excpt) {
    std::stringstream ss;
...
void TeamcityBoostLogFormatter::log_exception_start(std::ostream &out, boost::unit_test::log_checkpoint_data const &, const boost::execution_exception& excpt) {
